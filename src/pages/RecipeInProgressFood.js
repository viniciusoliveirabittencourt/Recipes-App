...
export default function RecipeInProgressFood() {
  ...
  useEffect(() => {
    ...
    if (savedProgress && savedProgress.meals[recipeMock.idMeal]) {
      const newCheckboxValue = savedProgress.meals[recipeMock.idMeal];
  ...
  const handleCheckbox = (ingredient) => {
    ...
    newProgress.meals[recipeMock.idMeal] = newCheckboxValue;
  ...
  return (
    <div style={ { display: 'flex', flexDirection: 'column' } }>
      <InProgressHeader recipeObject={ recipeMock } type="Meal" />
      <InProgressBody
